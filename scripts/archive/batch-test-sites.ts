...
async function runBatch() {
    // 1-5. 国家, 北京, 天津, 河北, 辽宁 - OK (Commented out to save time)
    /*
    await crawlSite('https://www.nda.gov.cn/sjj/zwgk/zcfb/list/index_pc_1.html', { container: ".list ul li", fields: { "标题": "a", "链接": "a::attr(href)", "发布日期": "span" } }, 'batch_1_nda.xlsx');
    await crawlSite('https://zwfwj.beijing.gov.cn/zwgk/2024zcwj/', { container: ".public_list_team ul li", fields: { "标题": "a", "链接": "a::attr(href)", "发布日期": "span" } }, 'batch_2_beijing.xlsx');
    await crawlSite('https://data.tj.gov.cn/zwgk/zcwj/', { container: ".news-list-item", fields: { "标题": ".news-list-item--title", "链接": "a::attr(href)", "发布日期": ".news-list-item--time" } }, 'batch_3_tianjin.xlsx');
    await crawlSite('https://szj.hebei.gov.cn/zwgk/002004/policyInter.html', { container: "#resultlist tr", fields: { "标题": "td a", "链接": "td a::attr(href)", "发布日期": "td:nth-child(3) p" } }, 'batch_4_hebei.xlsx');
    await crawlSite('https://dsj.ln.gov.cn/dsj/zwgk/zdgk/zcwj/index.shtml', { container: ".list ul li", fields: { "标题": "a", "链接": "a::attr(href)", "发布日期": "span" } }, 'batch_5_liaoning.xlsx');
    */
